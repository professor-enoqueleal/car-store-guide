...
1) Garanta que você possui o IntelliJ Instalado no seu computador. Caso não tenha faça a instalação conforme demonstrado nesse gif animado: [Instalando o IntelliJ no Windows](https://youtu.be/RBxAySum8UU).
